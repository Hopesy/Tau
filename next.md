...
- [x] session lifecycle（session delete / export JSON download / export.html / export.md / search by title / import file upload / title rename / last-opened session restore baseline / clear messages 端点）
