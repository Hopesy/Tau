...
- 本轮开始时 committed baseline 已到 `241155b feat(pods): stream vllm logs with follow mode`，`main` 与 `origin/main` 对齐；该提交已包含 Pods realtime log follow、duplicate configured deployment guard、operation `failureKind` 输出、history 和部分文档同步。
