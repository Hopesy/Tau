...
1. 先关闭低歧义 contract 缺口：Pods top-level command compatibility / operation schema；CodingAgent RPC exact schema / full jiti/custom tool extension runtime；CodingAgent image/clipboard ingestion；WebUi sandbox/tool/artifact runtime API。
